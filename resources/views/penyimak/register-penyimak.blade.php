...
<section class="mt-5 d-flex align-items-center">
  <div class="container w-75 px-5">
    ...
    <p><a class="text-black" href="/">Beranda</a> / Registrasi Penyimak</p>

    <div class="section-title text-center">
      <h2>Registrasi Penyimak</h2>
    ...
    <form action="{{ route('penyimak.store') }}" method="POST">
      @csrf
      ...
      <!-- TIPE PENYIMAK -->
      <div class="mb-3">
        <label class="form-label">Tipe Penyimak</label>
        <select name="tipe" id="tipe" class="form-select" required onchange="toggleForm()">
          <option disabled selected>Pilih Tipe</option>
          <option value="eksternal">Penyimak Eksternal UB</option>
          <option value="pengurus">Penyimak Internal UB (Mahasiswa)</option>
        </select>
      </div>
