...
<section class="mt-5 d-flex align-items-center">
  <div class="container w-75 px-5">
    ...
    <p><a class="text-black" href="/">Beranda</a> / Register Pengurus</p>

    <div class="section-title text-center">
      <h2>Registrasi Pengurus</h2>
    ...
    <form action="{{ route('pengurus.store') }}" method="POST">
      ...
      <div class="mb-3">
        ...
        <select name="jabatan" class="form-select" required>
          ...
          <option value="Ketua Departemen Tahfidz">Ketua Departemen Tahfidz</option>
          <option value="Wakil Ketua Departemen Tahfidz">Wakil Ketua Departemen Tahfidz</option>
        </select>
      </div>
